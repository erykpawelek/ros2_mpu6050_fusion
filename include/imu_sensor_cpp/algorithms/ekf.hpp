...
namespace imu_ekf
{
    ...
    */
    ...
    public:
        ...
        * @param magnitude_low_threshold Minimal value of gravity vector magnitude to be calculated on (linear acceleration filtering).
        * @param magnitude_high_threshold Maximum value of gravity vector magnitude to be calculated on (linear acceleration filtering).
        */
    ...
    private:
        ...
        */
        ...
        double magnitude_low_threshold_; 
